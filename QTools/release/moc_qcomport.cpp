...
**
** Created: Thu May 30 16:29:54 2013
...
void QComPort::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData QComPort::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QComPort::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QComPort,
      qt_meta_data_QComPort, &staticMetaObjectExtraData }
};
